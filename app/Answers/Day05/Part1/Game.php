...
namespace Mentosmenno2\AdventOfCode2022\Answers\Day05\Part1;
...
final class Game extends GameAbstract
{
	...
	protected function start(): void
	{
		foreach ($this->steps as $step) {
			for ($i=0; $i < (int) $step['boxes']; $i++) {
				$box_to_move = (string) array_pop($this->stacks[$step['from']]);
				$this->stacks[$step['to']][] = $box_to_move;
			}
		}
